...
<?php $__FOR_START_8__=1;$__FOR_END_8__=count($list);for($i=$__FOR_START_8__;$i < $__FOR_END_8__;$i+=1){ if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    <td><?php echo ($i); ?></td>
