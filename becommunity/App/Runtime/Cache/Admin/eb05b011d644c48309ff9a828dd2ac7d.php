...
<ol class="breadcrumb">
  ...
  <li class="active">修改编程库</li>
</ol>

</div>
  <div class="row  admin-box">
  <div class="col-md-12">
    <h4 class="text-center">修改编程库</h4>
    <form action="<?php echo U('doModifyProgramme');?>" method="post" class="form-horizontal" enctype="multipart/form-data" id="subForm" enctype="multipart/form-data">
      <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">编程库名称：</label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="inputEmail3" name="title" placeholder="编程库名称" autofocus="autofocus" value="<?php echo ($c['title']); ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          ...
          <input type="hidden" class="form-control" name="pho1" value="<?php echo ($c['logo']); ?>">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-6">
          ...
          <input type="hidden" class="form-control" name="pho2" value="<?php echo ($c['bgimg']); ?>">
        </div>
      </div>
      <div class="form-group">
      ...
      <option value='<?php echo ($c["tid"]); ?>'><?php echo ($c["typename"]); ?></option>
     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vv["tid"]); ?>'><?php echo ($vv["typename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
      <textarea class="form-control" rows="3"  placeholder="编程库介绍" name="introduce"><?php echo ($c["introduce"]); ?></textarea>
      </div>
    </div>
     <div class="form-group">
