...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    ...
    <td><img src="<?php echo ($vo["headimg"]); ?>" width="30" height="30"></a></td>
    <td><?php echo ($vo["nicheng"]); ?></td>
    
    <td>
    <?php switch($vo["power"]): case "1": ?>管理员<?php break;?>
      <?php case "2": ?>超级管理员<?php break;?>
      <?php case "0": ?>信息员<?php break; endswitch;?>
      
    </td>
  	<td>
     <?php if($vo["id"] != $id): ?><a href="<?php echo U('modifyAdmin');?>?id=<?php echo ($vo["id"]); ?>"  class="admin-modify" >修改</a>
