...
<span class="hot-color">提示：</span>文章缩略图会自动选取第一张图片，可自动获取。<span class="hot-color">如果文章来自其他网站，请一定要填来源去处！</span><br>
...
<br>如果使用过程中遇到问题可以查阅帮助手册。
	...
	<div class="col-md-12">
		...
		<form class="form-horizontal" method="post" action="<?php echo U('Index/addNews');?>">
		  <div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">文章标题：</label>
		    <div class="col-sm-6">
		      <input type="text" class="form-control" id="inputEmail3" autofocus="autofocus" placeholder="文章标题" name="title" autofocus="autofocus">
		    </div>
		  </div>
		  <div class="form-group">
		    ...
		    <label for="inputPassword3" class="col-sm-2 control-label">来源、链接</label>
	    		...
	    		<label for="inputPassword3" class="col-sm-4 control-label" id="original">
		    		   <input type="radio" class="radio" name="original" value="1" checked="true" style="float:left;"> 原创
		    		 </label>
 		    		<label for="inputPassword3" class=" control-label" id="nonOriginal">
		    		   <input type="radio" class="radio" name="original" value="2" style="float:left;"> 非原创
		    		 </label>

		    	</div>
		  </div>
  		  <div class="form-group" id="choseOther" style="display:none;">
		    <label for="inputPassword3" class="col-sm-2 control-label"></label>
        <div class="col-sm-6">
		    <div class="col-sm-5">
				<input type="text" class="form-control" id="inputEmail3" placeholder="文章来源地方"  name="from">
			</div>
		    <div class="col-sm-5">
				<input type="text" class="form-control" id="inputEmail3"  name="link" placeholder="文章链接">
			</div>
		    	</div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-6">
			<textarea class="form-control" rows="3" name="summary" placeholder="文章摘要（可自动获取）"></textarea>
		  </div>
		</div>
		  <div class="form-group">
...
<script type="text/javascript">
	...
	$('#nonOriginal input[name="original"]').click(function(){
