...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  	<td><a href="__ROOT__/index.php/Community/wenti?id=<?php echo ($vo["qid"]); ?>" target="_blank"><img src="__PUBLIC__/Uploads/head/<?php echo ($vo["headimg"]); ?>" width="30" height="30" alt="<?php echo ($vo["nicheng"]); ?>"></a></td>
  	<td><a href="__ROOT__/index.php/Community/wenti?id=<?php echo ($vo["qid"]); ?>" target="_blank"><?php echo ($vo["nicheng"]); ?></a></td>
    <td><a href="__ROOT__/index.php/Community/wenti?id=<?php echo ($vo["qid"]); ?>" target="_blank">《<?php echo ($vo["qtitle"]); ?>》</a></td>
