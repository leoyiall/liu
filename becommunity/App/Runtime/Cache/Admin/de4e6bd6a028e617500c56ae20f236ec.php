...
<form action="<?php echo U('index');?>" method="post">
    ...
    <input type="text" name="so" class="form-control" placeholder="对知识导图进行搜索..." style="width:200px;float:right;">
  </form>  
  </th>
</tr>
  <tr>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  	<td><a href="__ROOT__/index.php/Question/wenti?id=<?php echo ($vo["qid"]); ?>" target="_blank"><img src="<?php echo ($vo["headimg"]); ?>" width="30" height="30" alt="<?php echo ($vo["nicheng"]); ?>"></a></td>
  	<td><a href="__ROOT__/index.php/Question/wenti?id=<?php echo ($vo["qid"]); ?>" target="_blank"><?php echo ($vo["nicheng"]); ?>(<?php echo ($vo["user"]); ?>)</a></td>
    <td><a href="__ROOT__/index.php/Question/wenti?id=<?php echo ($vo["qid"]); ?>" target="_blank"><img src="__PUBLIC__/Uploads/learn/<?php echo ($vo["pit"]); ?>" width="30" height="30" alt="<?php echo ($vo["nicheng"]); ?>"></a></td>
    <td><a href="__ROOT__/index.php/Programme/propit?id=<?php echo ($vo["bid"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></td>
...
$(".admin-del").on("click",function(){
    if(confirm("是否删除该知识导图?")){
      var del = $(this);
      var ms=mdtool.messager();
      var aid = del.attr("delId");
       $.ajax({
        url : "<?php echo U('deleteLearn');?>?id="+aid,
        type:'get',
        datatype:'json',
        success:function(e){
          console.log(e);
