...
<table class="table table-hover">
  <tr>
   ...
   <tr>
   <td></td>
  	<td><input type="text" name="state" class="form-control" placeholder="状态名称"  autofocus="autofocus"></td>
  	<td>
  ...
  <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
    ...
    <td class="caname" objId="<?php echo ($vo["id"]); ?>"><?php echo ($vo["state"]); ?></td>
    <td><a href="<?php echo U('delState');?>?id=<?php echo ($vo["id"]); ?>" class='admin-modify' objId='<?php echo ($vo["id"]); ?>' onclick="confirm('确定删除该状态吗?')">删除</a></td>
...
$(document).ready(function(){
  ...
  var url = "<?php echo U('modifyState');?>?id="+id+"&con="+newtxt; 
