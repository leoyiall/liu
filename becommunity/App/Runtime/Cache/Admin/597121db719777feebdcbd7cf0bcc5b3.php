...
<ol class="breadcrumb">
  ...
  <li class="active">添加知识导图</li>
</ol>

</div>
  <div class="row  admin-box">
  <div class="col-md-12">
    <h4 class="text-center">添加知识导图</h4>
    <form action="<?php echo U('doAddpit');?>" method="post" class="form-horizontal" enctype="multipart/form-data" id="subForm" enctype="multipart/form-data">
      <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">知识导图上传：</label>
        <div class="col-sm-6">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <button type="button" class="btn btn-default"style="margin-left:200px;" id="sub">添加知识导图</button>
        </div>
      </div>
    </form>
  </div>
