...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    ...
    <td><a href="__ROOT__/index.php/Programme" target="_blank"><img src="__PUBLIC__/Uploads/programme/<?php echo ($vo["logo"]); ?>" width="30" height="30" alt="<?php echo ($vo["nicheng"]); ?>"></a></td>
    <td><a href="__ROOT__/index.php/Programme/programme?id=<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></td>
    <td><?php echo ($vo["typename"]); ?></td>
    
    <td><?php echo date('Y-m-d H:i:s',$vo['sendTime']); ?></td>
  	<td>
    <a href="<?php echo U('modifyProgramme');?>?id=<?php echo ($vo["id"]); ?>" class="admin-modify" >修改</a>
