...
<ol class="breadcrumb">
  ...
  <div class="col-md-12">
    <h4 class="text-center">修改课程</h4>
    <form action="<?php echo U('doModifyCourse');?>" method="post" class="form-horizontal" enctype="multipart/form-data" id="subForm">
      <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">课程名称：</label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="inputEmail3" name="title" placeholder="课程名称" autofocus="autofocus" value="<?php echo ($c['course']); ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          ...
          <input type="hidden" name="pho" value="<?php echo ($c['logo']); ?>">
        </div>
      </div>
      <div class="form-group">
      ...
      <option value='<?php echo ($c["pid"]); ?>'><?php echo ($c["title"]); ?></option>
     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vv["id"]); ?>'><?php echo ($vv["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
      <input type="text" class="form-control" id="inputEmail3" placeholder="老师名字" name="teacher" value='<?php echo ($c["teacher"]); ?>'>
        </div>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
      <textarea class="form-control" rows="3"  placeholder="教师介绍" name="introduce"><?php echo ($c["introduce"]); ?></textarea>
      </div>
    </div>
      <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">课程介绍</label>
        <div class="col-sm-6">
      <textarea class="form-control" rows="3"  placeholder="课程介绍" name="cintroduce"><?php echo ($c["cintroduce"]); ?></textarea>
      </div>
    </div>
      <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">课程目标</label>
        <div class="col-sm-6">
      <textarea class="form-control" rows="3"  placeholder="课程目标" name="target"><?php echo ($c["target"]); ?></textarea>
      </div>
    </div>
      <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">课程计划</label>
        <div class="col-sm-6">
      <textarea class="form-control" rows="3"  placeholder="课程计划" name="plan"><?php echo ($c["plan"]); ?></textarea>
      </div>
    </div>
     <div class="form-group">
