...
<!-- 左侧导航 -->
	<div class="admin-left">
		<ul class=''>
				<!-- 功能管理 -->
			<li class="left-title" style="margin:5px auto;">问答管理</li>
			<li class="left-li"><span class="li-quote">▶</span><a href="<?php echo U('Question/index');?>" target="_self">问题管理</a></li>
			<li class="left-li"><span class="li-quote">▶</span><a href="<?php echo U('Question/commentManage');?>" target="_self">评论管理</a></li>
			<li class="left-li"><span class="li-quote">▶</span><a href="<?php echo U('Question/addSort');?>" target="_self">问题分类</a></li>
		</ul>
	</div>	
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  	<td><a href="__ROOT__/index.php/question/wenti?id=<?php echo ($vo["ques_id"]); ?>" target="_blank"><img src="__PUBLIC__/Uploads/head/<?php echo ($vo["headimg"]); ?>" width="30" height="30" alt="<?php echo ($vo["nicheng"]); ?>"></a></td>
  	<td><a href="__ROOT__/index.php/question/wenti?id=<?php echo ($vo["ques_id"]); ?>" target="_blank"><?php echo ($vo["nicheng"]); ?></a></td>
    <td><a href="__ROOT__/index.php/question/wenti?id=<?php echo ($vo["ques_id"]); ?>" target="_blank">《<?php echo ($vo["qtitle"]); ?>》</a></td>
