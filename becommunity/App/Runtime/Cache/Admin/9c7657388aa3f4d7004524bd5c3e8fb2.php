...
<!-- 左侧导航 -->
	<div class="admin-left">
		<ul class=''>
				<!-- 功能管理 -->
			<li class="left-title" style="margin:5px auto;">社区管理</li>
			<li class="left-li"><span class="li-quote">▶</span><a href="<?php echo U('Community/index');?>" target="_self">社区文章</a></li>
			<li class="left-li"><span class="li-quote">▶</span><a href="<?php echo U('Community/commentManage');?>" target="_self">评论管理</a></li>
			<li class="left-li"><span class="li-quote">▶</span><a href="<?php echo U('Community/addSort');?>" target="_self">文章分类</a></li>
		</ul>
	</div>	
...
<tr>
  <th colspan="6">
<form action="<?php echo U('commentManage');?>" method="post">
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  	<td><a href="__ROOT__/index.php/Community/wenti?id=<?php echo ($vo["ques_id"]); ?>" target="_blank"><img src="__PUBLIC__/Uploads/head/<?php echo ($vo["headimg"]); ?>" width="30" height="30" alt="<?php echo ($vo["nicheng"]); ?>"></a></td>
  	<td><a href="__ROOT__/index.php/Community/wenti?id=<?php echo ($vo["ques_id"]); ?>" target="_blank"><?php echo ($vo["nicheng"]); ?></a></td>
    <td><a href="__ROOT__/index.php/Community/wenti?id=<?php echo ($vo["ques_id"]); ?>" target="_blank">《<?php echo ($vo["qtitle"]); ?>》</a></td>
  	<td><?php echo ($vo['sendTime']); ?></td>
  	<td>
  		<a href="javascript:void(0);" delId="<?php echo ($vo["qid"]); ?>" class="admin-modify admin-del" >删除</a>
  	</td>
...
$(".admin-del").on("click",function(){
    if(confirm("是否删除该回复?")){
      ...
      var aid = del.attr("delId");
       $.ajax({
        url : "<?php echo U('deleteComment');?>?id="+aid,
        type:'get',
        datatype:'json',
        success:function(e){
          console.log(e);
