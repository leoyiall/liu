...
<tr>
  <th colspan="6">
<form action="<?php echo U('shoulu');?>" method="post">
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    ...
    <td><?php echo date('Y-m-d H:i:s',$vo['sendTime']); ?></td>
  	<td>
  		<a href="javascript:void(0);" delId="<?php echo ($vo["qid"]); ?>" class="admin-modify admin-del" >收录</a>
  	</td>
...
$(".admin-del").on("click",function(){
    if(confirm("是否收录该话题?")){
      ...
      var aid = del.attr("delId");
       $.ajax({
        url : "<?php echo U('getTitle');?>?id="+aid,
        type:'get',
        datatype:'json',
        success:function(e){
          console.log(e);
