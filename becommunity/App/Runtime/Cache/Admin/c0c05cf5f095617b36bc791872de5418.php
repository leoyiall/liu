...
<div class="admin-nav">
	<div style="width:1000px;margin:0 auto;">
			...
			<?php if($data[0]['power'] != 0): ?><li><a href="<?php echo U('Adminlist/index');?>">管理员中心</a></li>
...
<?php $__FOR_START_13782__=1;$__FOR_END_13782__=count($list);for($i=$__FOR_START_13782__;$i < $__FOR_END_13782__;$i+=1){ if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    <td><?php echo ($i); ?></td>
    <td class="caname" objId="<?php echo ($vo["id"]); ?>"><?php echo ($vo["category"]); ?></td>
