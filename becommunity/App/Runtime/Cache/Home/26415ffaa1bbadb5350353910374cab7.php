...
<!--       <form id='search_form' class='navbar-search' action="<?php echo U('search');?>" style="margin-left:10px;">
  <input type='text' id='q' name='q' class='search-query span3' value='' style="height:26px;">
      ...
      <ul class='nav pull-left'>
        ...
        <li><a href="/about" style="color:#fff;">编程库</a></li>
...
<!-- 问题列表 -->
    <div class="inner no-padding">
      <div id="topic_list" style="width:500px;margin:0 auto;margin-top:20px;padding-bottom:50px;">
    <form action="<?php echo U('modifyZiliao');?>" method="post" enctype="multipart/form-data">
          <table>
            <tr>
              <td align="right">头像:&nbsp;&nbsp;</td>
              <td align="left">
                <?php if($ll['headimg']): ?><img src="__PUBLIC__/Uploads/head/<?php echo ($ll['headimg']); ?>" width="100" height="100" alt="<?php echo ($ll['nicheng']); ?>" style="border:1px solid #eee;">
                  <input type="hidden" name="headimg" value="<?php echo ($ll['headimg']); ?>"><?php endif; ?>
                <input type="file" name="photo" style="outline:none;border:none;">
              </td>
            </tr>
            <tr>
              <td align="right">昵称:&nbsp;&nbsp;</td>
              <td align="left">
                <input type="text" name="nicheng" class="form-control" style="height:35px;line-height:35px;margin-top:10px;" value="<?php echo ($ll['nicheng']); ?>">
                <input type="hidden" name="usid" class="form-control" style="height:35px;line-height:35px;margin-top:10px;" value="<?php echo ($ll['usid']); ?>">
              </td>
            </tr> 
            <tr>
              <td align="right">自我介绍:&nbsp;&nbsp;</td>
              <td align="left">
                <textarea name="about" rows="5" cols="10" class="form-control" style="font-size:12px;"><?php echo ($ll['about']); ?></textarea>
              </td>
            </tr>
<!--             <tr>
    <td>最擅长的领域:&nbsp;&nbsp;</td>
    <td>
        <?php if(is_array($ly)): $i = 0; $__LIST__ = $ly;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i; if($vv['tid'] == 5): ?><input type="radio" name="know" value="<?php echo ($vv["tid"]); ?>" checked="true"><?php echo ($vv["typename"]); ?>
          <?php else: ?>
            <input type="radio" name="know" value="<?php echo ($vv["tid"]); ?>" checked="false"><?php echo ($vv["typename"]); endif; endforeach; endif; else: echo "" ;endif; ?>
    </td> 
  </tr>  -->  
            <tr>
              <td colspan="2">
              <center>
                <input type="submit" value="修改资料" class="btn btn-info"  style="margin-top:30px;">
              </center>
              </td>
            </tr>         
          </table>
