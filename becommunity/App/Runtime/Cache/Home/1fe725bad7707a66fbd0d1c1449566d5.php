...
<div class="mainCol clearfix padding15px">
	...
	<div class="kn_cloumn ">
		<ul class="list01 clearfix">
			<!-- 一个知识库开始 -->
			<?php if(is_array($all)): $i = 0; $__LIST__ = $all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li>
				<div class="spantop bk0">
					<div class="imgtop">
						<img src="__PUBLIC__/Uploads/programme/<?php echo ($vv["bgimg"]); ?>" width="360" height="94">
					</div>
					<span>
						<a href="<?php echo U('programme');?>?id=<?php echo ($vv["id"]); ?>" target="_blank"><img src="__PUBLIC__/Uploads/programme/<?php echo ($vv["logo"]); ?>" width="80" height="80" ></a>
					</span>
				</div>
				<p>
					<a href="<?php echo U('programme');?>?id=<?php echo ($vv["id"]); ?>" class="title" target="_blank"><?php echo ($vv["title"]); ?></a><span class="content"><?php echo ($vv["introduce"]); ?></span>
				</p>
