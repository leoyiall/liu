...
<!--       <form id='search_form' class='navbar-search' action="<?php echo U('search');?>" style="margin-left:10px;">
  <input type='text' id='q' name='q' class='search-query span3' value='' style="height:26px;">
      ...
      <ul class='nav pull-left'>
        ...
        <li><a href="<?php echo U('Blog/index');?>" target="_blank" style="color:#fff;">博客</a></li>
        <li><a href='<?php echo U("question/index");?>' style="color:#fff;">问答</a></li>
        
        <li><a href="<?php echo U('Community/index');?>" target="_blank" style="color:#fff;">社区</a></li>
        <li><a href="<?php echo U('Index/index');?>"  target="_blank" style="color:#fff;">资讯</a></li>
        <li><a href="/about" target="_blank" style="color:#fff;">编程库</a></li>
        <li><a href="<?php echo U('Code/index');?>"  target="_blank" style="color:#fff;">源码</a></li>
        <li><a href="<?php echo U('Index/down');?>"  target="_blank" style="color:#fff;">软件</a></li>
         </ul>
         <ul class='nav pull-right'>
           ...
           <a href="<?php echo U('personCenter');?>?id=<?php echo ($idnumber); ?>" style="color:#fff;"><?php echo ($idnumber); ?></a><?php endif; ?>
             ...
             <?php else: ?>
                 <li><a href="<?php echo U('Common/login');?>?l=community">登录</a></li>
