		...
		<div class="module_div c13">
			...
			<div id="nav" class="nav" style="position: static; opacity: 1; top: 0px; left: 0px; z-index: 4;margin-top:-20px;">
				<div class="mainCol padding15px clearfix">
					...
					<div class="navtabs">
						<a href="<?php echo U('programme');?>?id=<?php echo ($p['id']); ?>" class="root">主页</a>
...
<!-- 主体结束 -->
	<div class="mainCol padding15px addcolor" style="padding-bottom:50px;">
		<div class="kn_left w850px c13">
			
			<div class="kn_column01 clearfix whitebk">
				<div class="kn_column kn_title">
					<span class="title"><i class="fa fa-bookmark"></i>&nbsp;&nbsp;<a href="<?php echo U('learnProgramme');?>?id=<?php echo ($p['id']); ?>&l=<?php echo ($p['sort']); ?>">学习资源</a></span>
				</div>
	<div class="kn_column_content clearfix">			
	<div id="resource_list">
		<div class="clearfix"></div>
<div  class="scrollDoc">
<?php if(!$sp): ?><h3>暂未收录教学视频</h3>
<?php else: ?>
	<ul class="learnMore">
	<?php if(is_array($sp)): $i = 0; $__LIST__ = $sp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li>
		<dl>
		<dd><a href="<?php echo U('programme/teachProgramme');?>?id=<?php echo ($p['id']); ?>&kid=<?php echo ($vv["id"]); ?>">
			<img src="__PUBLIC__/Uploads/learn/<?php echo ($vv["logo"]); ?>" width="200" height="125"  style="float:left;margin-right:10px;">
		</a></dd>
			 <dd style="padding-top:30px;">
				<a href="<?php echo U('programme/teachProgramme');?>?id=<?php echo ($p['id']); ?>&kid=<?php echo ($vv["id"]); ?>"><?php echo ($vv["course"]); ?></a><br><br>
				<span>浏览:<?php echo ($vv["sight"]); ?></span>
			 </dd>
			</dl>	
...
<script>
	$(function(){
		$('.listinofrs').on('mouseover','a',function(){
			$(".sr-bdimgshare.sr-bdimgshare-list").remove();
		})
	})
</script></div>
				</div>
...
<div class="kn_column01 clearfix whitebk">
		<div class="kn_column kn_title">
			<span class="title"><i class="fa fa-bookmark"></i>&nbsp;&nbsp;<a href="<?php echo U('shouluList');?>?id=<?php echo ($p['id']); ?>&l=<?php echo ($p['sort']); ?>">精彩收录</a></span>
		</div>
		<div class="kn_column_content clearfix">
			<ul class="listul">
				<?php if(!$sl): ?><li align="center">还没有精彩收录,快来<br>
				...
				<?php else: ?>
				<!-- 一个收录 -->
				<?php if(is_array($sl)): $i = 0; $__LIST__ = $sl;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li class="clearfix">
						<span class="tu">
...
<!-- 相关问答 -->
	<div class="kn_column01 clearfix whitebk">
			<div class="kn_column kn_title">
				<span class="title"><i class="fa fa-bookmark"></i>&nbsp;&nbsp;<a href="<?php echo U('aboutQuestion');?>?id=<?php echo ($p['id']); ?>&l=<?php echo ($p['sort']); ?>">相关问答</a></span>
			</div>
			<div class="kn_column_content clearfix">
				<ul class="listul">
					<?php if(!$wt): ?><li align="center">还没有相关问答,快来<br>
					<center><a href="<?php echo U('Question/addQuestion');?>" class="layerbtn getstructorimgbtn backgroundcolor" target="_blank">发布相关问题</a></center></li>
				<?php else: ?>
				<!-- 一个收录 -->
				<?php if(is_array($wt)): $i = 0; $__LIST__ = $wt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li class="clearfix">
						<span class="tu">
							<a href="<?php echo U('question/wenti');?>?id=<?php echo ($vv["qid"]); ?>" target="_blank"><img src="__PUBLIC__/Uploads/head/<?php echo ($vv["headimg"]); ?>" width="35" height="35" data-bd-imgshare-binded="1"></a>
						</span>
						<div class="csdn-tracking-statistics" data-mod="popu_229_lib_13">
							<a knid="271" contentid="8610" href="<?php echo U('question/wenti');?>?id=<?php echo ($vv["qid"]); ?>" title="<?php echo ($vv["qtitle"]); ?>" class="title" target="_blank"><?php echo ($vv["qtitle"]); ?></a>
							<span class="ding number">
								<i class="fa fa-eye"></i><?php echo ($vv["sight"]); ?>
							</span>
						</div>
...
<div class="kn_column01 clearfix whitebk">
	<div class="kn_column_content">
		<div class="divtop csdn-tracking-statistics" data-mod="popu_234">
			<a href="<?php echo U('propit');?>?id=<?php echo ($p['id']); ?>&l=<?php echo ($p['sort']); ?>" target="_blank">
				<img src="__PUBLIC__/Uploads/programme/<?php echo ($p['bgimg']); ?>" width="231" height="106" alt="" data-bd-imgshare-binded="1">
			</a>
		</div>
		<div class="divbottom">
			<div class="title">
				<a href="<?php echo U('propit');?>?id=<?php echo ($p['id']); ?>&l=<?php echo ($p['sort']); ?>" target="_blank"><?php echo ($p['title']); ?> 知识图谱</a>
			</div>
		</div>
	</div>
</div>
