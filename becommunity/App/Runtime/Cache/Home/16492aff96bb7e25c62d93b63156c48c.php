			...
			<div id="nav" class="nav" style="position: static; opacity: 1; top: 0px; left: 0px; z-index: 4;margin-top:-20px;">
				<div class="mainCol padding15px clearfix">
					...
					<div class="navtabs">
						...
						<a href="<?php echo U('aboutQuestion');?>?id=<?php echo ($p['id']); ?>&l=<?php echo ($p['sort']); ?>" class="root">相关问答</a>
...
<!-- 相关问答 -->
	<div class="kn_column01 clearfix whitebk">
			<div class="kn_column kn_title">
				<span class="title"><i class="fa fa-bookmark"></i>&nbsp;&nbsp;相关问答</span>
			</div>
			<div class="kn_column_content clearfix">
				<ul class="listul">
					<!-- 一个收录 -->
					<?php if(!$list): ?><li align="center">还没有相关问答,快来<br>
					<center><a href="<?php echo U('question/addQuestion');?>" class="layerbtn getstructorimgbtn backgroundcolor" target="_blank">发布相关问答</a></center></li>
				<?php else: ?>
				<!-- 一个收录 -->
