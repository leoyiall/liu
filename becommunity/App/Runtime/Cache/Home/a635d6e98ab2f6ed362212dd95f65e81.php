			...
			<div id="nav" class="nav" style="position: static; opacity: 1; top: 0px; left: 0px; z-index: 4;margin-top:-20px;">
				<div class="mainCol padding15px clearfix">
					...
					<div class="navtabs">
						...
						<a href="<?php echo U('propit');?>?id=<?php echo ($p['id']); ?>&l=<?php echo ($p['sort']); ?>" class="root">知识图谱</a>
					</div>
				</div>
			</div>
		</div>
...
<!-- 精彩收录 -->
	<div class="kn_column01 clearfix whitebk">
			<div class="kn_column kn_title">
				<span class="title"><i class="fa fa-bookmark"></i>&nbsp;&nbsp;知识图谱</span>
			</div>
			<div class="kn_column_content clearfix">
			<?php if(is_array($pro)): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><img src="__PUBLIC__/Uploads/learn/<?php echo ($vv["pit"]); ?>" width="100%" height="100%" alt="<?php echo ($p['title']); ?>">
				<ul class="listul" style="overflow:hidden;*zoom:1;">
					<li align="center" style="overflow:hidden;*zoom:1;">
					<center><a href="__PUBLIC__/Uploads/learn/<?php echo ($vv["pit"]); ?>" class="layerbtn getstructorimgbtn backgroundcolor" target="_blank">预览大图</a></center>
					</li>					
