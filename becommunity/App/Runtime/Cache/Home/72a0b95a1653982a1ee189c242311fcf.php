  ...
  <?php if($idnum == $id && $idnum!=''): ?><div class="userinfo"> 
    ...
    <div class="rightBox">
      ...
      <?php if(is_array($bool)): $i = 0; $__LIST__ = $bool;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><div class="blogList">
        <h2 class="title" style="width:480px;overflow:hidden;">
        <a href="<?php echo U('article');?>?id=<?php echo ($id); ?>&lid=<?php echo ($vv["lid"]); ?>"> <?php if($vv["prev"] == 1): ?>[技术前沿]<?php endif; ?>
    <?php echo ($vv["title"]); ?></a></h2>
        <div class="rightTime">
