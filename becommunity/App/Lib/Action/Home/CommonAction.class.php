...
class CommonAction extends Action {
	...
	public function dologin(){
	   ...
	   if($list['upass'] == md5(md5($pass))){
	        ...
	        $data["info"]= "登录成功,正在跳转";
	        if($l == "blog"){
		        $data['link']= U('Blog/index')."?id=".$list['idnumber'];	
	        }else if($l == "question"){
	        	$data['link']= U('Question/index')."?id=".$list['idnumber'];	
	        }else if($l == "yuanma"){
	        	$data['link']= U('Code/index')."?id=".$list['idnumber'];	
	        }else if($l == "community"){
	        	$data['link']= U('Community/index')."?id=".$list['idnumber'];	
	        }else if($l == "programme"){
	        	$data['link']= U('Programme/index')."?id=".$list['idnumber'];	
	        }else if($l == "index"){
	        	$data['link']= U('Main/index')."?id=".$list['idnumber'];	
	        }else{
	        	$data['link']= U('About/index')."?id=".$list['idnumber'];
	        }
