...
<div class="mainContent2">
    <aside>
      ...
      <?php else: ?>
        <?php if($idnubmer != $id): ?><p class="btns"><a href="<?php echo U('privateMessage');?>?id=<?php echo ($id); ?>" target="_blank" >私信</a><span  id="careHim"><a href="JavaScript:void(0);" onclick="carehim()" >关注</a></span></p><?php endif; endif; ?>
      </div> 
