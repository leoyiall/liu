...
<div class="mainContent2">
    ...
    <div class="blogitem">
    <h2 style="padding-left:20px;margin-top:20px;border-bottom:1px solid #ccc;">资料修改</h2>
   <form action="<?php echo U('saveAbout');?>" method="post">
      <table>
      <tr>
        <th>博客昵称:</th>
        <td>
          <input type="text" name="nicheng" autofocus class="input_style" value="<?php echo ($ab['nicheng']); ?>">
        	<input type="hidden" name="user_id" autofocus class="input_style" value="<?php echo ($id); ?>">
        </td>
      </tr>
        <tr>
          <th>真实姓名:</th>
          <td><input type="text" name="real_name" class="input_style" value="<?php echo ($ab['real_name']); ?>"></td>
        </tr>
        <tr>
          <th>性　　别:</th>
          <td>

<input type="radio" name="sex" value="1" <?php if($ab['sex'] == 1): ?>checked<?php endif; ?>>男
<input type="radio" name="sex" value="0" <?php if($ab['sex'] == 0): ?>checked<?php endif; ?>>女
          </td>
        </tr>
        <!-- <tr>
               <th>生　　日:</th>
               <td>
                   <input type="text" name="birthday" value="<?php echo ($ab['birthday']); ?>">
               </td>
             </tr>    -->     
        <tr>
          <th>现 居 地:</th>
          <td><input type="text" name="live" class="input_style" value="<?php echo ($ab['live']); ?>"></td>
        </tr> 
        <tr>
          <th>自我介绍:</th>
          <td>
		<textarea name="introduce"  cols="42" rows="5" sytle="font-size:14px;padding-left:3px;"><?php echo ($ab['introduce']); ?></textarea>
          </td>
        </tr>               
        <tr>
          <th align="center">Q Q:</th>
          <td><input type="number" name="qq" class="input_style" value="<?php echo ($ab['qq']); ?>"></td>
        </tr>  
        <tr>
          <th>邮　　箱:</th>
          <td><input type="email" name="email" class="input_style" value="<?php echo ($ab['email']); ?>"></td>
        </tr> 
        <tr>
          <th>兴　　趣:</th>
          <td>
            <input type="text" name="intersting" class="input_style" value="<?php echo ($ab['intersting']); ?>">
          </td>
        </tr> 
        <tr>
          <td colspan="2">
            <input  class="modifyAbout" type="submit" value="修改资料" style="cursor:pointer;">
          </td>
        </tr>
      </table>
    </form>
