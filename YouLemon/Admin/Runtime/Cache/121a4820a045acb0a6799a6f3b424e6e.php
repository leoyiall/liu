...
$(function(){
	...
	<div id="ht_addld">
		<div id="ht_gl">
			<div class="ht_biaoti">
				<img src="__PUBLIC__/Images/logo.png" ><span class="tj">添加二级分类</span>
			</div>
			<div id="ht_lie">
			<form action="__APP__/Houshop/add_two" method="post" name="myform" onsubmit="return checkform();">
				<p>一级分类名:
				...
				<p>二级分类名:<input type="text" placeholder="二级分类名称" name="sort2" class="person_wen"/></p>
