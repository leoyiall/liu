		...
		<div class="reg">
			...
			<form action="__ROOT__/admin.php/Index/reg" method="post" name="myform" onsubmit="return checkform();">
				<table border="0">
					<tr>
						<td>昵称:</td>
						<td><input type="text" name="nicheng" placeholder="您的昵称" class="person_wen"></td>
					</tr>
					<tr>
						<td>邮箱:</td>
						<td><input type="email" name="email"  placeholder="您的邮箱" class="person_wen">
						<input type="text" name="number" value="2" hidden></td>
					</tr>
					<tr>
						<td>手机:</td>
						<td><input type="text" name="phone" placeholder="您的手机" class="person_wen"></td>
					</tr>
					<tr>
