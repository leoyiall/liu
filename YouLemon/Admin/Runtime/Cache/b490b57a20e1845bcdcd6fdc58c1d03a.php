...
$(function(){
	...
	<div id="ht_addld">
		<div id="ht_gl">
			<div class="ht_biaoti">
				<img src="__PUBLIC__/Images/logo.png" ><span class="tj">修改一级分类</span>
			</div>
			<div id="ht_lie">
			<form action="__APP__/Houshop/modify_one?lid='<?php echo ($lei_id); ?>'" method="post" name="myform" onsubmit="return checkform();">
				<p>一级分类名:<input type="text" placeholder="一级分类名称" value="<?php echo ($lei_name); ?>" name="sort1" class="person_wen"/></p>
