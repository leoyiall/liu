...
<script type="text/javascript">
	function checkform(){
 	...
 	if (formYan.nicheng.value==""){
  		formYan.nicheng.focus();
  		formYan.nicheng.style.background="#F92659" 
  		return false; 
 	  }
 	if (formYan.email.value==""){
  		formYan.email.focus();   
  		formYan.email.style.background="#F92659"
  		return false; 
 	  }
 	if (formYan.phone.value==""){
  		formYan.phone.focus();   
  		formYan.phone.style.background="#F92659"
  		return false; 
 	  }
	}
...
<body>
	...
	<div id="index_top">
		<!-- 中间logo开始 -->
		<div id="index_logo">
			<a href="__APP__/admin.php/Houshop/ht_index"><img src="__PUBLIC__/Images/logo.png"></a>You柠檬商城后台
		</div>
		<!-- 右边身份和退出部分开始 -->
		<div id="index_logout">
...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<!-- 系统首页部分开始 -->
		<dl class="system_log">
			<dt onClick="changeImage()">系统首页<img src="__PUBLIC__/Images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="__APP__/Houshop/ht_index">系统首页</a></dd>
		</dl>
	<!-- 管理员信息部分开始 -->
		<dl class="custom">
			<dt onClick="changeImage()">个人中心<img src="__PUBLIC__/Images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="__APP__/Houshop/ht_person">个人资料</a></dd>
		</dl>
	<!-- 用户管理部分开始 -->
	<?php if($result == 1): ?><dl class="custom">
			<dt onClick="changeImage()">管理员管理<img src="__PUBLIC__/Images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="__APP__/Houshop/ht_addgl">增加管理员</a></dd>
			<dd><a href="__APP__/Houshop/ht_gllist">管理员列表</a></dd>
		</dl><?php endif; ?>
	<!-- 系统管理部分开始 -->
		<dl class="syetem_management">
			<dt>分类管理<img src="__PUBLIC__/Images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="ht_set1.php">添加一级分类</a></dd>
			<dd class="first_dd"><a href="ht_set2.php">添加二级分类</a></dd>
			<dd class="first_dd"><a href="ht_setall.php">分类管理</a></dd>
		</dl>
	<!-- 用户管理部分开始 -->
		<dl class="custom">
			<dt onClick="changeImage()">用户管理<img src="__PUBLIC__/Images/left/select_xl01.png"></dt>
	...
	<!-- 供应商部分开始 -->
		<dl class="source">
			<dt onClick="changeImage()">供应商管理<img src="__PUBLIC__/Images/left/select_xl01.png"></dt>
...
$(function(){
	...
	<div id="ht_addld">
		<div id="ht_gl">
			<div class="ht_biaoti">
				<img src="__PUBLIC__/Images/logo.png" ><span class="tj">修改商城用户</span>
			</div>
			<div id="ht_lie">
			<form action="__APP__/Houshop/domodify" method="post" name="myform" onsubmit="return checkform();">
				<p>用 户 名:<input type="text" placeholder="管理员用户名" value="<?php echo ($username); ?>" name="user" class="person_wen"/></p>
				<p>密　　码:<input type="password" placeholder="管理员密码"  name="pass" class="person_wen"/></p>
				<p>昵　　称:<input type="text" placeholder="管理员昵称" value="<?php echo ($nicheng); ?>" name="nicheng" class="person_wen"/></p>
				<p>邮　　箱:<input type="text" placeholder="管理员的邮箱" value="<?php echo ($email); ?>" name="email" class="person_wen"/></p>
				<p>手机号码:<input type="text" placeholder="管理员的手机号码" value="<?php echo ($phone); ?>" name="phone" class="person_wen"/></p>
				<input type="submit" value="修改用户" class="anniu"  />
