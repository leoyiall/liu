...
$(function(){
	...
	<div id="ht_addld">
		<div id="ht_gl">
			<div class="ht_biaoti">
				<img src="__PUBLIC__/Images/logo.png" ><span class="tj">添加商城管理员</span>
			</div>
			<div id="ht_lie">
			<form action="__APP__/Houshop/addgl" method="post" name="myform" onsubmit="return checkform();">
				<p>用 户 名:<input type="text" placeholder="管理员用户名" name="user" class="person_wen"/></p>
				<p>密　　码:<input type="password" placeholder="管理员密码" name="pass" class="person_wen"/></p>
				<p>昵　　称:<input type="text" placeholder="管理员昵称" name="nicheng" class="person_wen"/></p>
				<p>邮　　箱:<input type="text" placeholder="管理员的邮箱" name="email" class="person_wen"/></p>
				<p>手机号码:<input type="text" placeholder="管理员的手机号码" name="phone" class="person_wen"/></p>
				<p>密保问题1:您初中班主任叫什么名字?</p>
				<p><input type="text" placeholder="您的密保1答案" name="mibao1" class="person_wen"/></p>
				<p>密保问题2:您的宠物叫什么名字?</p>
				<p><input type="text" placeholder="您的密保2答案"  name="mibao2" class="person_wen"/></p>
				<input type="submit" value="添加管理员" class="anniu"  />
