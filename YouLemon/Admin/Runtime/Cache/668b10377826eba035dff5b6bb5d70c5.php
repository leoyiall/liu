	...
	<div id="ht_list">
		<div class="gl_list">
			...
			<table cellpadding="0" cellspacing="0" class="biaoge">
					<tr>
						<td colspan="3" class="gl_tou"><h3>&nbsp;栏目类别管理</h3></td>
					</tr>
					<tr>
						<th width="100">栏目一</th>
						<th>栏目二</th>
					...
					<?php if(is_array($so)): $i = 0; $__LIST__ = $so;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="left">
						<td><?php echo ($key); ?></td>
						<td align="left">
							<?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ss): $mod = ($i % 2 );++$i;?><!-- 								<?php if($vo["lei_id"] == $ss.lei_id): ?><span class="yf">&nbsp;&nbsp;<?php echo ($ss["lei2_name"]); ?>&nbsp;<a href="">修改</a>|<a href="">删除</a></span><?php endif; ?> -->
									<span class="yf"> <?php echo ($ss["lei2_name"]); ?>&nbsp;<a href="__APP__/Houshop/lm2_xiu?lid=<?php echo ($ss["l2_id"]); ?>">(修改</a>|<a href="__APP__/Houshop/lm2_shan?lid=<?php echo ($ss["l2_id"]); ?>" onclick="return confirm('确定要删除?');">删除</a>)</span><?php endforeach; endif; else: echo "" ;endif; ?>
						</td>
						<td ><a href="__APP__/Houshop/lm_xiu?lid=<?php echo ($ss["lei_id"]); ?>">修改</a>|<a href="__APP__/Houshop/lm_shan?lid=<?php echo ($ss["lei_id"]); ?>" onclick="return confirm('确定要删除?');">删除</a></td>
