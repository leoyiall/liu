...
$(function(){
	...
	<div id="ht_addld">
		<div id="ht_gl">
			<div class="ht_biaoti">
				<img src="__PUBLIC__/Images/logo.png" ><span class="tj">添加一级分类</span>
			</div>
			<div id="ht_lie">
			<form action="__APP__/Houshop/add_one" method="post" name="myform" onsubmit="return checkform();">
				<p>一级分类名:<input type="text" placeholder="一级分类名称" name="sort1" class="person_wen"/></p>
				<input type="submit" value="添加分类" class="anniu"  />
