				...
				<!-- 列表开始 -->
					<div id="gl_list">
						<table cellpadding="0" cellspacing="0">
							<tr>
						<td colspan="7" class="gl_tou">用户列表</td>
							</tr>
							<tr>
								<th>ID</th>
								<th>用户账号</th>
							...
							<?php if(is_array($all)): $i = 0; $__LIST__ = $all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
								<ul>
									<a href="__APP__/Houshop/yhmodify?id='<?php echo ($vv["user_id"]); ?>'" ><li class="xg">修改</li></a>
									<a href="__APP__/Houshop/yhdel?id='<?php echo ($vv["user_id"]); ?>'" onclick="return confirm('确认删除吗?');"><li class="del">删除</li></a>
								</ul>
								</td>
