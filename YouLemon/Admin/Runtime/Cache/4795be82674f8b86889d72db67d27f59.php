...
<div id="Con2">
	<!--按扭开始-->
	<div id="button" >
		<a  class="ys_tiao"><h1>发布供应商商品</h1></a>
	</div>
	<!--按扭结束-->
	...
	<div id="content2">
		<div class="txt_con"  style="display:block;">
			<form action="__APP__/Store/shopAll" method="post" enctype="multipart/form-data">
			<table>
				<tr class="te_gao">
					<td  align="right"><h3>商品编号:</h3></td>
					<td>
						<input type="text" name="shopNumber" class="person_wen"  placeholder="请输入商品编号">
					</td>
				</tr>	
				<tr class="te_gao">
					<td  align="right"><h3>商品id号:</h3></td>
					<td><input type="text" name="shopName" class="person_wen"  placeholder="请输入商品id号"><span class="ys_tiao">请联系您的供应商获得</span></td>
				</tr>		
				<tr>
					<td  colspan="2"><input type="submit" value="发布该商品" class="ys_lan btn"></td>
				</tr>		
			</table>
			</form>
		</div>
