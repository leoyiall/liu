...
<html lang="en">
 <head>
  ...
  <title>You柠檬商城供应商分类——快速寻找供应商</title> 
</head>
...
<div class="shoppingCart comWidth">
	<div class="shopping_item">
		<h3 class="shopping_tit">供应商分类<span class="ys_tiao">(选择分类后可以快速找到对应类型供应商!)</span></h3>
		...
		<div class="leftdiv">
			<?php if(is_array($so)): $i = 0; $__LIST__ = $so;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
                        <dt><a href="__APP__/Index/gys_list?lname=<?php echo ($key); ?>"><?php echo ($key); ?></a></dt>
                        <dd>
                        <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ss): $mod = ($i % 2 );++$i;?><a href="__APP__/Index/gys_list?lid=<?php echo ($ss["lei_id"]); ?>&lid2=<?php echo ($ss["l2_id"]); ?>&lname=<?php echo ($ss["lei_name"]); ?>"><?php echo ($ss["lei2_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>  	  
                        </dd>
