...
<div class="comWidth clearfix products">
	...
	<div class="rightArea">
		...
		<div class="hr_15"></div>
		<div class="addInfo">
			<div class="address" style="line-height:30px;font-size:14px;">
					当前位置:<strong><a href="__ROOT__/index.php/Index">首页</a></strong>
	<span>&nbsp;&gt;&nbsp;</span>
		<?php echo ($lname); ?>
			</div>
		</div>
		...
		<?php if(is_array($shop)): $i = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><div class="item">
				<div class="item_cont">
					<div class="img_item" style="margin-top:10px;">
						<a href="__ROOT__/index.php/Index/shopIntroduce?shopId=<?php echo ($vv["shop_id"]); ?>&iup=<?php echo ($vv["is_up"]); ?>&shnum=<?php echo ($vv["shopNum"]); ?>&shname=<?php echo ($vv["shopName"]); ?>&shimg=<?php echo ($vv["shopImage"]); ?>&shname=<?php echo ($vv["shopName"]); ?>&lname=<?php echo ($vv["lei_name"]); ?>&ss=<?php echo ($vv["storeName"]); ?>" target="_blank"><img src="__PUBLIC__/Images/shop/<?php echo ($vv["shopImage"]); ?>" alt="<?php echo ($vv["shopName"]); ?>" ></a>
					</div>
					<p><a href="__ROOT__/index.php/Index/shopIntroduce?shopId=<?php echo ($vv["shop_id"]); ?>&iup=<?php echo ($vv["is_up"]); ?>&shnum=<?php echo ($vv["shopNum"]); ?>&shname=<?php echo ($vv["shopName"]); ?>&shimg=<?php echo ($vv["shopImage"]); ?>&shname=<?php echo ($vv["shopName"]); ?>&lname=<?php echo ($vv["lei_name"]); ?>&ss=<?php echo ($vv["storeName"]); ?>" target="_blank"><?php echo ($vv["shopName"]); ?></a></p>
					<p class="money">￥<?php echo ($vv["shopPrice"]); ?></p>
