 ...
 <body>
  ...
  <nav class="navbar navbar-default" style="position:fixed;width:100%;overflow:hidden;*zoom:1;z-index:10;">
	...
	<div class="inPosition div2_top">
		当前位置：<a href="<?php echo U('index');?>">首页</a> >><a href="<?php echo U('lists');?>">栏目列表</a> >> <?php echo ($cs[0]['cName']); ?>
	</div>
	<div class="bg-info">
		<p style="line-height:30px;text-align:center;font-size:20px;"><b><?php echo ($cs[0]['cName']); ?></b></p>
		<p style="text-indent:2em;padding-bottom:10px;"><?php echo ($cs[0]['cIntroduce']); ?></p>
	</div>
	<!-- 左边文章栏目 -->
