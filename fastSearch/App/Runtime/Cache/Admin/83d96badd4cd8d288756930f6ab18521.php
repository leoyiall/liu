...
<html lang="en">
 ...
 <body style="background:url('__PUBLIC__/images/re.jpg')no-repeat top center;">
  	<div class="conWidth">
		<div class="logo_img">
			<a href=""><img src="__PUBLIC__/images/logo.png" alt="快搜"></a>
		</div>
  	</div>

  	<div class="login_box">
		<h2>注册</h2>
		<form action="hello.php" method="post" name="login">
	用 户 名 :
		<input type="text" name="user" placeholder="用户名" class="form_focus"><br>
	密　　码:
		<input type="text" name="pass" placeholder="密码" class="form_focus"><br>
	确认密码:
		<input type="text" name="repass" placeholder="确认密码" class="form_focus"><br>
	性　　别:
		...
		<br>
	昵　　称:
		<input type="text" name="nicheng" placeholder="昵称" class="form_focus"><br>
	<div class="div_center">	
		<button class="sub" id="enter">注册</button>
		<span class="span_left"><a href="">登录</a></span>
	</div>
		</form>
	<div class="div_center div_top">
		©copyright  by leo <a href="">首页</a>
	</div>
  	</div>
 </body>
</html>