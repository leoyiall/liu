	...
	<div class="conWidth">
      ...
      <div class="right_con fr">
          <div class="right_intro">
            <div class="fl">
              <img src="__PUBLIC__/images/333.jpg"  width="100" height="100">
            </div>
            <div class="fl">
              <dl>
                <dt>昵称:</dt>
                <dd><?php echo ($otherName); ?></dd>
              </dl>
            </div>
          </div>
          <!-- 我的文章列表 -->
          <div class="list_arc">
              <ul>
                <li class="me_title"><b>我的文章</b></li>
                <?php if(is_array($list)): foreach($list as $key=>$v): ?><li>
                    <a href="__ROOT__/index.php/Index/article/id/<?php echo ($v["id"]); ?>" target="_blank" class="fl" style="margin-left:10px;" title="<?php echo ($v["title"]); ?>"><?php echo ($v["title"]); ?></a>
                    <span class="fr" style="margin-right:10px;"><?php echo ($v["date"]); ?></span>
                  </li><?php endforeach; endif; ?>
               <li style="text-align:center;"><?php echo ($page); ?></li>
              </ul>
          </div>
      </div>  
      <!-- 左边导航 -->
