...
<html lang="en">
 ...
 <h3 class="text-center">修改文章分类</h3>
  <form class="form-horizontal" action="<?php echo U('doModifyCate');?>" method="post">
    <div class="form-group">
    <input type="text" name="id" value="<?php echo ($arr['0']['id']); ?>" style="display:none;">
      <label for="inputEmail3" class="col-sm-2 control-label">分类名称</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="inputEmail3" name="cName" value="<?php echo ($arr['0']['cName']); ?>" placeholder="文章名称">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
    <textarea  name="cIntroduce" cols="100%" rows="5" style="border:1px solid #ccc;"><?php echo ($arr['0']['cIntroduce']); ?></textarea>
        </div>
      </div>
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default">修改文章分类</button>
