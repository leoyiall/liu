      ...
      <div class="right_con fr">
          <div class="right_intro">
              <table class="table table-hover">
                ...
                <form action="<?php echo U('Index/addstate');?>" method="post"> 
                  <tr>
                  <th></th>
                  <th>    
                    <input type="text" class="form-control" name="state" onblur="modify(this,<?php echo ($vo["id"]); ?>)">
                  </th>
                  <th>
                  <input class="btn btn-default" type="submit"  id="add" value="添加状态">
                  </th>
                </tr>
                </form> 
             <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                  ...
                  <td>
                    <input type="text" class="form-control" name="s<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["state"]); ?>" onblur="modify(this,<?php echo ($vo["id"]); ?>)">
                  </td>
                  <td>
                    <a href="javascript:void(0)" data-link="<?php echo U('delstate');?>?id=<?php echo ($vo["id"]); ?>" class="btn btn-default" onclick="treat(this,'是否删除栏目?')" >删除</a>
                  </td>
...
<!--           <li>
 ...
 -->
    ...
    // ajax执行修改类别
    function modify(obj,sid){
      $.ajax({ 
        url: "<?php echo U('Index/modifyState');?>",
        type : "post", 
        datatype:'json',
        data : {
          id : sid,
