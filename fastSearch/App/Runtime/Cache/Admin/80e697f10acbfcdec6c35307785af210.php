...
<html lang="en">
 ...
 <h3 class="text-center">修改栏目</h3>
  <form class="form-horizontal" action="<?php echo U('doModifyLanmu');?>" method="post">
    ...
    <input type="text" name="id" value="<?php echo ($arr['0']['id']); ?>" style="display:none;">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="inputEmail3" name="cName" value="<?php echo ($arr['0']['cName']); ?>" placeholder="栏目名称">
      </div>
    </div>
    <div class="form-group">
  ...
  <input type="text" name="cId" value="0" style="display:none;">
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default">修改栏目</button>
