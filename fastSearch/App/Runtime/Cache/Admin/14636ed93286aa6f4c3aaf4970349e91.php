...
<html lang="en">
 ...
 <h3 class="text-center">发布文章</h3>
  <form class="form-horizontal" action="<?php echo U('addSend');?>" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
          <textarea name="summary" placeholder="这里输入摘要" style="border:1px solid #ccc;" rows="5" cols="120"></textarea>
      </div>
    </div>
      <div class="form-group">
